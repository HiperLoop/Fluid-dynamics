...
\subsection*{d)}
When zooming in at the stagnation point around the sharp trailing edge, for the values $\Gamma = 0$ and $\Gamma = -2.8$, which we can see in figure \ref{fig:placeholder0} and \ref{fig:placeholder1} respectively, you can notice that the stagnation point moves more back on the wing when the magnitude of the vortex gets larger. A stagnation point on the wing itself creates turbulence and drag. The aim is therefore always to make the streamfunction smooth, to create an efficient wing. 
\begin{figure}[H]
    \centering

    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{\PATH d_streamfunction_gamma--0.2.png}
        \caption{}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{\PATH d_streamfunction_gamma--2.8.png}
        \caption{}
        \label{fig:placeholder1}
    \end{subfigure}

    \caption{Streamfunction zoomed in at the stagnation point around the sharp trailing edge for $\Gamma = -0.2$ (a) and $\Gamma = -2.8$ (b)}
