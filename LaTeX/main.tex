...
\subsection*{a)}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{a_scatter.png}
...
\subsection*{b)}
    ...
    In figure \ref{fig:b_streamfunction_gamma0} and \ref{fig:b_streamfunction_gamma-3} you can see the plottet streamfunction around the cylinder for $\Gamma = 0$ and $\Gamma = -3$. The velocity potentials are plottet in figure \ref{fig:b_velocity_potential_gamma0} and \ref{fig:b_velocity_potential_gamma-3}.
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{b_streamfunction_gamma0.png}
        \caption{}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{b_streamfunction_gamma-3.png}
        \caption{}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{b_velocity_potential_gamma0.png}
        \caption{}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{b_velocity_potential_gamma-3.png}
        \caption{}
...
The streamfunctions are plotted in figure \ref{fig:c_streamfunction_gamma0} and \ref{fig:c_streamfunction_gamma-3}. Both boundary conditions seem to be met. Further away from the wing, streamfunction looks undisturbed and parallel, and the streamfunction is never perpendicular to the surface of the cylinder.
   ...
   \begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{c_streamfunction_gamma0.png}
        \caption{}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{c_streamfunction_gamma-3.png}
        \caption{}
...
\subsection*{d)}
When zooming in at the stagnation piont around the sharp trailing edge, for the values $\Gamma = 0$ and $\Gamma = -3$, you can notice that the stagnation point moves more back on the wing when the magnitude of the vortex gets larger. A stagnation point on the wing itself creates turbulence and drag. The aim is therefore always to make the streamfunction smooth, to create an efficient wing. 
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{d_streamfunction_gamma-3.png}
    \caption{Streamfunction zoomed in at the stagnation point around the sharp trailing edge. $\Gamma = -3$}
...
\subsection*{e)}
    ...
    To find the best fitting $\Gamma$ to make our stream smooth, we find the value for $\Gamma$ such that the velocity at the trailing edge is as close as possible to 0. The value that we got from trying this out is $\Gamma = -2.5$. In figure \ref{fig:e_streamfunction_gamma-2.5} we plotted the streamfunction for this value and in figure \ref{fig:e_zoomed_streamfunction_gamma-2.5}, where we zoom in on the trailing edge, you can see better how smooth the streamfunction is. 
    \begin{figure}[H]
    \centering
    
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{e_streamfunction_gamma-2.5.png}
        \caption{}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{e_zoomed_streamfunction_gamma-2.5.png}
        \caption{}
        \label{fig:e_zoomed_streamfunction_gamma-2.5}
    \end{subfigure}
    
    \caption{Streamfunction for $\Gamma=2.5$ (a) and zoomed in on the trailing edge.}
    \end{figure}

\subsection*{f)}
    For the value of $\Gamma = -2.5$, we plot the pressure field around the cylinder in \ref{fig:f_Cylinder_pressure} and around the wing in \ref{fig:f_Wing_pressure}.
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f_Cylinder_pressure.png}
        \caption{}
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{f_Wing_pressure.png}
        \caption{}
...
\subsection*{h)}
    ...
    F_y=i\rho U\Gamma
    $$
    Filling in the values for $U, \rho$ and $\Gamma$:
    $$
    F_y = i \cdot 101,305 \text{ Ph } \cdot 1 \cdot -2.5 = 253,206.5 \text{ N/m}
    $$
