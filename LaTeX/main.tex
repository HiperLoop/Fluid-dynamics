...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{d_streamfunction_zoom_gamma0.png}
        \caption{}
        \label{fig:e_streamfunction_zoom_gamma0}
    \end{subfigure}
    \hfill
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{d_streamfunction_zoom_gamma-1.png}
        \caption{}
        \label{fig:e_zoomed_streamfunction_zoom_gamma-1}
    \end{subfigure} \\
    \begin{subfigure}
        {0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{d_streamfunction_zoom_gamma-2.png}
        \caption{}
        \label{fig:e_zoomed_streamfunction_zoom_gamma-2}
    \end{subfigure}
    \hfill
    \begin{subfigure}
        {0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{d_streamfunction_zoom_gamma-3.png}
        \caption{}
        \label{fig:d_streamfunction_zoom_gamma-3}
    \end{subfigure}
